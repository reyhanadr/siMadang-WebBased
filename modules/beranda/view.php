        ...
        <div class="col-lg-12 col-xs-12">
            <div class="alert alert-info alert-dismissable">
                ...
                <p style="font-size:15px">
                    ...
                    <strong><?php echo $_SESSION['nama_user']; ?></strong> di Aplikasi Management Gudang Konveksi.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          if ($_SESSION['hak_akses']!='Manajer') { ?>
                <a href="?module=barang" class="small-box-footer" title="Tambah Data" data-toggle="tooltip"><i
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            ?>
                ...
                <?php  
          if ($_SESSION['hak_akses']!='Manajer') { ?>
                <a href="?module=barang_masuk" class="small-box-footer" title="Tambah Data" data-toggle="tooltip"><i
                        class="fa fa-plus"></i></a>
                <?php
          } else { ?>
                <a class="small-box-footer"><i class="fa"></i></a>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            ?>
                ...
                <a href="?module=lap_barang_masuk" class="small-box-footer" title="Cetak Laporan"
                    data-toggle="tooltip"><i class="fa fa-print"></i></a>
            </div>
        </div><!-- ./col -->
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <h4>
                                ...
                                <span class="small">Oleh : <b>Operator</b> - 28-7-2023 00:00</span><br /><br />

                                <b>Laporan Barang Masuk (2)</b> <span class="badge bg-purple">PENTING</span><br />
                                <span class="small">Oleh : <b>Operator</b> - 28-7-2023 00:00 </span>
                            </h4>
                            <hr />
                        </li>
                    </ul>
